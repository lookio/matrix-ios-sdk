...
- (MXHTTPOperation *)paginate:(NSUInteger)numItems direction:(MXTimelineDirection)direction onlyFromStore:(BOOL)onlyFromStore complete:(void (^)(NSArray<MXEvent *> *))complete failure:(void (^)(NSError *))failure
{
